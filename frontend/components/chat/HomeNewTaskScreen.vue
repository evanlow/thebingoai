<template>
  <div :class="['home-screen', { 'is-sending': props.isSending }]">
    <div class="home-inner">
      ...
      <!-- Reserves vertical space for the floating ChatInputBar on the New Task screen. -->
      <div class="home-composer-reserve" aria-hidden="true" />
...
import { Sparkles, Activity, ChevronRight } from 'lucide-vue-next'
...
/* ── Composer reservation slot ───────────────────────────── */
.home-composer-reserve {
  height: calc(var(--composer-h, 200px) + 56px);
}
...
/* ── Heading fade-out when transitioning ────────────────────── */
.home-hero-eyebrow,
.home-hero-heading,
.home-hero-sub {
