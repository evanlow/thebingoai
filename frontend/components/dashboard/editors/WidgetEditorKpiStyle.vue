<template>
  <div class="h-full overflow-y-auto p-5 space-y-5 [&>*+*]:border-t [&>*+*]:border-gray-200 [&>*+*]:pt-5">
    ...
    <!-- Primary metric -->
    <div class="space-y-3">
      <h3 class="text-[11px] font-medium text-gray-500 dark:text-neutral-400 uppercase tracking-wide">Primary Metric</h3>
      ...
      <div class="flex items-center justify-between py-1">
        ...
        <button
          ...
          :disabled="!editMode"
          class="relative inline-flex h-5 w-9 flex-shrink-0 rounded-full transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:ring-offset-1 disabled:opacity-40 disabled:cursor-not-allowed"
          :class="localCompactNumbers ? 'bg-indigo-600' : 'bg-gray-200 dark:bg-neutral-600'"
      ...
      <div class="flex items-center justify-between py-1">
        <span class="text-sm text-gray-700 dark:text-neutral-200">Round value</span>
        <button
          type="button"
          role="switch"
          ...
          :disabled="!editMode"
          class="relative inline-flex h-5 w-9 flex-shrink-0 rounded-full transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:ring-offset-1 disabled:opacity-40 disabled:cursor-not-allowed"
          :class="localRoundValue ? 'bg-indigo-600' : 'bg-gray-200 dark:bg-neutral-600'"
    ...
    <!-- Comparison fields -->
    <div class="space-y-3">
      <h3 class="text-[11px] font-medium text-gray-500 dark:text-neutral-400 uppercase tracking-wide">Comparison Fields</h3>
      ...
      <div class="flex items-center justify-between py-1">
        ...
        <button
          ...
          :disabled="!editMode"
          class="relative inline-flex h-5 w-9 flex-shrink-0 rounded-full transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:ring-offset-1 disabled:opacity-40 disabled:cursor-not-allowed"
          :class="localCompactComparison ? 'bg-indigo-600' : 'bg-gray-200 dark:bg-neutral-600'"
      ...
      <div class="flex items-center justify-between py-1">
        <span class="text-sm text-gray-700 dark:text-neutral-200">Show absolute change</span>
        <button
          type="button"
          role="switch"
          ...
          :disabled="!editMode"
          class="relative inline-flex h-5 w-9 flex-shrink-0 rounded-full transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:ring-offset-1 disabled:opacity-40 disabled:cursor-not-allowed"
          :class="localShowAbsoluteChange ? 'bg-indigo-600' : 'bg-gray-200 dark:bg-neutral-600'"
      ...
      <div class="flex items-center justify-between py-1">
        <span class="text-sm text-gray-700 dark:text-neutral-200">Hide comparison label</span>
        <button
          type="button"
          role="switch"
          ...
          :disabled="!editMode"
          class="relative inline-flex h-5 w-9 flex-shrink-0 rounded-full transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:ring-offset-1 disabled:opacity-40 disabled:cursor-not-allowed"
          :class="localHideComparisonLabel ? 'bg-indigo-600' : 'bg-gray-200 dark:bg-neutral-600'"
    ...
    <!-- Progress visual -->
    <div class="space-y-3">
      <h3 class="text-[11px] font-medium text-gray-500 dark:text-neutral-400 uppercase tracking-wide">Progress Visual</h3>
      <div class="space-y-1.5">
    ...
    <!-- Labels -->
    <div class="space-y-3">
      <h3 class="text-[11px] font-medium text-gray-500 dark:text-neutral-400 uppercase tracking-wide">Labels</h3>
      ...
      <div class="flex items-center justify-between py-1">
        <span class="text-sm text-gray-700 dark:text-neutral-200">Hide field name</span>
        <button
          type="button"
          role="switch"
          ...
          :disabled="!editMode"
          class="relative inline-flex h-5 w-9 flex-shrink-0 rounded-full transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:ring-offset-1 disabled:opacity-40 disabled:cursor-not-allowed"
          :class="localHideFieldName ? 'bg-indigo-600' : 'bg-gray-200 dark:bg-neutral-600'"
      ...
      <div class="flex items-center justify-between gap-2">
        ...
        <div class="flex items-center gap-2 flex-1 max-w-[140px]">
          <input
            ...
            @input="emitUpdate()"
          />
          <span class="text-[11px] text-gray-500 dark:text-neutral-400 tabular-nums w-8 text-right">{{ localOpacity }}%</span>
        </div>
      </div>
