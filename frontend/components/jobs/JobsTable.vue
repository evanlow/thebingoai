    ...
    <div class="overflow-x-auto">
      <table class="w-full">
        <thead class="border-b border-neutral-200 bg-neutral-50 dark:border-neutral-800 dark:bg-neutral-900">
          <tr>
            <th class="px-4 py-3 text-left text-sm font-normal uppercase tracking-wider text-neutral-700 dark:text-neutral-300">
              File
            </th>
            <th class="px-4 py-3 text-left text-sm font-normal uppercase tracking-wider text-neutral-700 dark:text-neutral-300">
              Namespace
            ...
            <th class="px-4 py-3 text-right text-sm font-normal uppercase tracking-wider text-neutral-700 dark:text-neutral-300">
              Actions
            </th>
          </tr>
        </thead>
