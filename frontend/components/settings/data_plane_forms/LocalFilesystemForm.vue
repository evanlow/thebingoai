<template>
  <div class="space-y-4">
    <div>
      <label class="block text-sm font-medium text-gray-700 dark:text-neutral-300 mb-1">Root Path</label>
      <input
      ...
      />
      <p class="mt-1 text-sm text-gray-500 dark:text-neutral-400">Docker volume path or local directory for Parquet files.</p>
    </div>
  </div>
</template>
