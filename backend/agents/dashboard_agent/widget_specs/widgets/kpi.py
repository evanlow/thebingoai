...
class KpiWidget(BaseWidget):
    ...
    params_doc = (
        ...
        "- `aggregation` (sum|avg|count|countDistinct|min|max|first|last): default 'sum'. "
        "ALWAYS set explicitly to match the KPI's purpose (avg, countDistinct, last, ...); "
        "omission means a plain total (sum)\n"
