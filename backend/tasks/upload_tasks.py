...
celery_app.conf.update(
    ...
    include=["backend.tasks.memory_tasks", "backend.tasks.heartbeat_tasks", "backend.tasks.skill_detection_tasks", "backend.tasks.dashboard_refresh_tasks", "backend.tasks.agent_tasks", "backend.tasks.profiling_tasks", "backend.tasks.semantic_tasks", "backend.tasks.briefing_tasks", "backend.tasks.watermark_tasks", "backend.pipelines.tasks", "backend.transforms.tasks"],
)
